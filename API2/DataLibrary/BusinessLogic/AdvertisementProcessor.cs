...
namespace DataLibrary.BusinessLogic
{
	...
	{
		public async static Task<int> AddPostAsync(AdvertisementModel itemModel)
		{
			var sql = $@"INSERT INTO advertisement(ItemName, ItemDescription, ItemCategory,	ItemCount, City, Tele, Price, Image, Con, Negotiable) " +
						"VALUES(@ItemName, @ItemDescription, @ItemCategory, @ItemCount, @City, @Tele, @Price, @Image, @Con, @Negotiable)";
